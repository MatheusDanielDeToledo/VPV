...
function participar(req, res) {
    var id = req.body.id;
    var ong = req.body.ong;
    var missao = req.body.missao

    usuarioModel
      .participar(id, ong, missao)
      .then(function (resultado) {
        res.json(resultado);
      })
      .catch(function (erro) {
...
function cadastrar(req, res) {
  ...
  usuarioModel
    .cadastrar(nome, email, senha, codigo)
    .then(function (resultado) {
      res.json(resultado);
    })
    .catch(function (erro) {
